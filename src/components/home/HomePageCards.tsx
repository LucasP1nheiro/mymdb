...
const HomePageCards = ({movie} : MovieCardProps) => {
  ...
  return (
    <div 
        className="h-96 w-[250px] shadow-xl bg-zinc-300/5 text-white font-extrabold hover:brightness-50 hover:scale-95 hover:z-2 cursor-pointer transition-all duration-500" 
        key={movie.id}
    >
